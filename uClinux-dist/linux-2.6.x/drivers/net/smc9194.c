...
static struct devlist smc_devlist[] __initdata = {
	{ .port = 0x30600300, .irq = 29 },
	{ .port = 0x30600000, .irq = 27 },
	{ .port = 0, .irq = 0  }
};
#elif defined(CONFIG_SH_KEYWEST)
static struct devlist smc_devlist[] __initdata = {
	{ .port = KEYWEST_ETHR, .irq = IRQ4_IRQ },
	{ .port = 0, .irq = 0  }
};
#elif defined(CONFIG_M68EZ328)
/* make sure that you program Port D selects to allow the interrupts! */
static struct devlist smc_devlist[] __initdata = {
	{ .port = 0x2000300, .irq = IRQ1_IRQ_NUM },
	{ .port = 0x2000300, .irq = IRQ2_IRQ_NUM },
	{ .port = 0, .irq = 0  }
};
