...
#if __frv__
#define	BYTES_PER_WORD		8 /* the compiler uses LDD/STD insns where possible */
#elif (defined(CONFIG_UCSIMM) || defined(CONFIG_UCDIMM) || defined(CONFIG_DRAGEN2)|| defined(CONFIG_CWEZ328) || defined (CONFIG_CWVZ328)) && !DEBUG
...
static cache_sizes_t cache_sizes[] = {
	...
	{  2048,	NULL, NULL},
	{  4096,	NULL, NULL},
#if !defined(CONFIG_CONTIGUOUS_PAGE_ALLOC) || PAGE_SIZE >= 8192
	{  8192,	NULL, NULL},
#endif
#if !defined(CONFIG_CONTIGUOUS_PAGE_ALLOC) || PAGE_SIZE >= 16384
	{ 16384,	NULL, NULL},
#endif
#if !defined(CONFIG_CONTIGUOUS_PAGE_ALLOC) || PAGE_SIZE >= 32768
	{ 32768,	NULL, NULL},
#endif
#if !defined(CONFIG_CONTIGUOUS_PAGE_ALLOC)
	{ 65536,	NULL, NULL},
	{131072,	NULL, NULL},
#ifdef NO_MM
	{262144,	NULL, NULL},
