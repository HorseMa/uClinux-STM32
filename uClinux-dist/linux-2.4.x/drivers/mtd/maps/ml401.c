/****************************************************************************/
/*
 * Flash memory access on uClinux Microblaze systems on Xilinx ML401 board
...
static __u8 ml401_read8(struct map_info *map, unsigned long ofs)
{
	return *(__u8 *)(map->map_priv_1 + ofs);
}

static __u16 ml401_read16(struct map_info *map, unsigned long ofs)
{
	return *(__u16 *)(map->map_priv_1 + ofs);
}

static __u32 ml401_read32(struct map_info *map, unsigned long ofs)
{
	return *(__u32 *)(map->map_priv_1 + ofs);
}

static void ml401_copy_from(struct map_info *map, void *to, unsigned long from, ssize_t len)
{
	memcpy(to, (void *)(map->map_priv_1 + from), len);
}

static void ml401_write8(struct map_info *map, __u8 d, unsigned long adr)
{
	*(__u8 *)(map->map_priv_1 + adr) = d;
}

static void ml401_write16(struct map_info *map, __u16 d, unsigned long adr)
{
	*(__u16 *)(map->map_priv_1 + adr) = d;
}

static void ml401_write32(struct map_info *map, __u32 d, unsigned long adr)
{
	*(__u32 *)(map->map_priv_1 + adr) = d;
}

static void ml401_copy_to(struct map_info *map, unsigned long to, const void *from, ssize_t len)
{
...
static struct map_info ml401_flash_map = {
	name:		"Flash",
	read8:		ml401_read8,
	read16:		ml401_read16,
	read32:		ml401_read32,
	copy_from:	ml401_copy_from,
	write8:		ml401_write8,
	write16:	ml401_write16,
	write32:	ml401_write32,
	copy_to:	ml401_copy_to,
};

static struct map_info ml401_ram_map = {
	name:		"RAM",
	read8:		ml401_read8,
	read16:		ml401_read16,
	read32:		ml401_read32,
...
static struct mtd_partition ml401_romfs[] = {
	{ name: "Romfs", offset: 0 }
};
...
static struct mtd_partition ml401_128k[] = {
...
static struct mtd_partition ml401_1mb[] = {
	{ name: "Bootloader", offset: 0x00000000, size:   0x00004000 },
...
static struct mtd_partition ml401_2mb[] = {
	{ name: "Bootloader", offset: 0x00000000, size:   0x00004000 },
	{ name: "Bootargs",   offset: 0x00004000, size:   0x00002000 },
	{ name: "MAC",        offset: 0x00006000, size:   0x00002000 },
	{ name: "Config",     offset: 0x00010000, size:   0x00010000 },
...
static struct mtd_partition ml401_4mb[] = {
	{ name: "Bootloader", offset: 0x00000000, size:   0x00004000 },
	{ name: "Bootargs",   offset: 0x00004000, size:   0x00004000 },
	{ name: "MAC",        offset: 0x00008000, size:   0x00004000 },
	{ name: "Config",     offset: 0x00010000, size:   0x00010000 },
...
static struct mtd_partition ml401_8mb[] = {
	{ name: "fpga0",      offset: 0x00000000, size:   0x00100000 },
	{ name: "fpga1",      offset: 0x00100000, size:   0x00100000 },
	{ name: "Bootloader", offset: 0x00200000, size:   0x00040000 },
	{ name: "Bootargs",   offset: 0x00240000, size:   0x00040000 },
	{ name: "MAC",        offset: 0x00280000, size:   0x00040000 },
	{ name: "Config",     offset: 0x002C0000, size:   0x00080000 },
	{ name: "Spare",      offset: 0x00340000, size:   0x000C0000 },
	{ name: "Image",      offset: 0x00400000, size:   0x00300000 },
	{ name: "JFFS2",      offset: 0x00700000, size:   0x00100000 },
	{ name: "Flash",      offset: 0 }
};
...
static int ml401_reboot_notifier(
	struct notifier_block *nb,
	unsigned long val,
	void *v)
{
	struct cfi_private *cfi = ml401_flash_map.fldrv_priv;
	int i;
	
	for (i = 0; cfi && i < cfi->numchips; i++)
		cfi_send_gen_cmd(0xff, 0x55, cfi->chips[i].start, &ml401_flash_map,
				cfi, cfi->device_type, NULL);

	return(NOTIFY_OK);
}

static struct notifier_block ml401_notifier_block = {
	ml401_reboot_notifier, NULL, 0
};
...
static int
ml401_point(struct mtd_info *mtd, loff_t from, size_t len,
...
static void
ml401_unpoint (struct mtd_info *mtd, u_char *addr, loff_t from, size_t len)
{
}
...
static int __init
ml401_probe(int ram, unsigned long addr, int size, int buswidth)
{
	struct mtd_info *mymtd;
	struct map_info *map_ptr;

	if (ram)
		map_ptr = &ml401_ram_map;
	else
		map_ptr = &ml401_flash_map;
	...
	mymtd->point = ml401_point;
	mymtd->unpoint = ml401_unpoint;
	mymtd->priv = map_ptr;

	if (ram) {
		ram_mtdinfo = mymtd;
		add_mtd_partitions(mymtd, ml401_romfs, NB_OF(ml401_romfs));
		return(0);
	}
	...
	switch (size) {
	case SIZE_128K:
		add_mtd_partitions(mymtd, ml401_128k, NB_OF(ml401_128k));
		break;
	case SIZE_1MB:
		add_mtd_partitions(mymtd, ml401_1mb, NB_OF(ml401_1mb));
		break;
	case SIZE_2MB:
		add_mtd_partitions(mymtd, ml401_2mb, NB_OF(ml401_2mb));
		break;
	case SIZE_4MB:
		add_mtd_partitions(mymtd, ml401_4mb, NB_OF(ml401_4mb));
		break;
	case SIZE_8MB:
		add_mtd_partitions(mymtd, ml401_8mb, NB_OF(ml401_8mb));
		break;
	}
...
int __init ml401_mtd_init(void)
{
	int rc = -1;
	struct mtd_info *mtd;
	...
	if (rc != 0)
		rc = ml401_probe(0, FLASH_BASE, SIZE_8MB, BUS_WIDTH);
#endif

#if defined(CONFIG_FLASH4MB) || defined(CONFIG_FLASHAUTO)
	if (rc != 0)
		rc = ml401_probe(0, FLASH_BASE, SIZE_4MB, BUS_WIDTH);
#endif

#if defined(CONFIG_FLASH2MB) || defined(CONFIG_FLASHAUTO)
	if (rc != 0)
		rc = ml401_probe(0, FLASH_BASE, SIZE_2MB, BUS_WIDTH);
#endif

#if defined(CONFIG_FLASH1MB) || defined(CONFIG_FLASHAUTO)
	if (rc != 0)
		rc = ml401_probe(0, FLASH_BASE, SIZE_1MB, BUS_WIDTH);
#endif

#if defined(CONFIG_FLASH128K) || defined(CONFIG_FLASHAUTO)
	if (rc != 0)
		rc = ml401_probe(0, FLASH_BASE, SIZE_128K, BUS_WIDTH);
#endif
	...
	if (0 != ml401_probe(1, (unsigned long) romfs_loc,
...
static void __exit ml401_mtd_cleanup(void)
{
	if (flash_mtdinfo) {
	...
	if (ml401_ram_map.map_priv_1) {
		iounmap((void *)ml401_ram_map.map_priv_1);
		ml401_ram_map.map_priv_1 = 0;
	}
	if (ml401_flash_map.map_priv_1) {
		iounmap((void *)ml401_flash_map.map_priv_1);
		ml401_flash_map.map_priv_1 = 0;
	}
}

/****************************************************************************/

module_init(ml401_mtd_init);
module_exit(ml401_mtd_cleanup);

MODULE_LICENSE("GPL");
MODULE_AUTHOR("John Williams <jwilliams@itee.uq.edu.au>");
MODULE_DESCRIPTION("Microblaze/ML401 Flash support for uClinux");
