...
{
	if (Instance < 0 || Instance >= CONFIG_XILINX_SYSACE_NUM_INSTANCES) {
		return NULL;
	}
...
#if 1
#define XSA_IRQ (CONFIG_XILINX_SYSACE_0_IRQ)
#else
...
xsysace_init(void)
{
	static const unsigned long remap_size
	    = CONFIG_XILINX_SYSACE_0_HIGHADDR - CONFIG_XILINX_SYSACE_0_BASEADDR + 1;
	XSysAce_Config *cfg;
