...
static char *serial_name = "Winbond W90N740 Serial driver";
...
static struct serial_uart_config uart_config[] =
        {
                ...
                { "W90N740", 1, 0},	/* Winbond w90n740 uart support */
                { 0, 0}
        };
...
static int startup(struct async_struct * info)
{
        ...
        */
        serial_outp(info,COM_TOR, 0x80+0x20); /* Timeout if more than ??? bits xfer time */
        CSR_WRITE (AIC_SCR6, 0x41);  /* high-level sensitive, priority level 1 */
