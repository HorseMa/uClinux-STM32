...
* All rights reserved.
* 
* $Header: /cvs/sw/linux-2.4.x/drivers/net/re865x/rtl865x/Attic/rtl865xc_asicregs.h,v 1.1.2.1 2007/09/28 14:42:31 davidm Exp $
*
...
#define MIB_CONTROL                            			 (0x00+0x1000+SWCORE_BASE)   /*MIB control Register */
...
#define BCSC_DISUNKNOWNUNICAST              (1<<14)     /* Disable control for unknown unicast packet */
#define BCSC_DISMULTICAST                   (1<<13)     /* Disable control for multicast packet */
#define BCSC_DISBROADCAST                   (1<<12)     /* Disable control for broadcast packet */
...
/* P0GMIICR Port-0 GMII Configuration Register */
...
#define MultiPortModeP_OFFSET               (5)                   /* Multicast Port Mode */
...
#define BC_withPIFG                         (1<<0)                /* Bandwidth Conrol Include/Exclude Preamble&IFG. 0:exclude; 1:include */

/* IBCR0 - Ingress Bandwidth Control Register 0 */
#define BWC_P1_OFFSET                       (16)                  /* Port1 Ingress Bandwidth Control */
#define BWC_P1_MASK                         (0xffff<<16)          /* Port1 Ingress Bandwidth Control */
#define BWC_P0_OFFSET                       ( 0)                  /* Port0 Ingress Bandwidth Control */
#define BWC_P0_MASK                         (0xffff<< 0)          /* Port0 Ingress Bandwidth Control */

/* IBCR1 - Ingress Bandwidth Control Register 1 */
#define BWC_P3_OFFSET                       (16)                  /* Port3 Ingress Bandwidth Control */
#define BWC_P3_MASK                         (0xffff<<16)          /* Port3 Ingress Bandwidth Control */
#define BWC_P2_OFFSET                       ( 0)                  /* Port2 Ingress Bandwidth Control */
#define BWC_P2_MASK                         (0xffff<< 0)          /* Port2 Ingress Bandwidth Control */

/* IBCR2 - Ingress Bandwidth Control Register 2 */
#define BWC_P5_OFFSET                       (16)                  /* Port5 Ingress Bandwidth Control */
#define BWC_P5_MASK                         (0xffff<<16)          /* Port5 Ingress Bandwidth Control */
#define BWC_P4_OFFSET                       ( 0)                  /* Port4 Ingress Bandwidth Control */
#define BWC_P4_MASK                         (0xffff<< 0)          /* Port4 Ingress Bandwidth Control */
...
#define EN_8021Q2LTMPRI7				21
#define EN_8021Q2LTMPRI6				18
#define EN_8021Q2LTMPRI5				15
#define EN_8021Q2LTMPRI4				12
#define EN_8021Q2LTMPRI3				 9
#define EN_8021Q2LTMPRI2				 6
#define EN_8021Q2LTMPRI1				 3
#define EN_8021Q2LTMPRI0				 0
...
#define EN_1QTAGVIDIGNORE			 		(1<<31)                 /* Enable 1Q vlan unware*/
