...
* All rights reserved.
* 
* $Header: /cvs/sw/linux-2.4.x/drivers/net/re865x/rtl865x/Attic/rtl865xb_asicregs.h,v 1.1.2.1 2007/09/28 14:42:31 davidm Exp $
*
...
*
* Revision 1.8  2006/08/29 13:00:00  chenyl
* *: New SWNIC driver for RTL865xC
* *: some rearrange in re_core.c for Bootstrap sequence being more readable.
*
* Revision 1.7  2006/07/06 04:13:39  brian_bin
* fix PCM SCR register bit definition
*
* Revision 1.6  2006/07/03 03:05:08  chenyl
* *: convert files from DOS format to UNIX format
*
* Revision 1.5  2006/05/09 06:09:01  tony
* *: bug fixed : NIC model code, register read/write.
*
