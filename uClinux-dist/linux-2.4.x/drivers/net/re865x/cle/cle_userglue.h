...
* -------------------------------------------------------
* $Id: cle_userglue.h,v 1.1.2.1 2007/09/28 14:42:24 davidm Exp $
*/

#ifndef _CLE_USERGLUE_
#define _CLE_USERGLUE_

#if defined(RTL865X_MODEL_USER) || defined (RTL867X_MODEL_USER)
...
#endif	/* defined(RTL865X_MODEL_USER) || defined (RTL867X_MODEL_USER) */
