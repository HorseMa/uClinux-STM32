#if defined(CONFIG_RTL865X) || defined(CONFIG_RTL867X)
...
#include "rtl865x/rtl8672_asicregs.h"
#endif

#define rtl8366_drv 1
...
#include "mdcmdio_cmd.h"
#include "Rtl8306_AsicDrv_cmd.h"
#endif

#ifdef CONFIG_RTL8363
#include "Rtl8363_Asic_cmd.h"
#endif
...
#include "rtl_igmp_cmd.h"
#endif

#ifdef CONFIG_MULTICAST_SNOOPING
#include "rtl_multicast_cmd.h"
#endif
...
#if defined(RTL865X_MODEL_USER)||defined(RTL865X_MODEL_KERNEL) || defined(RTL867X_MODEL_USER)
...
static cle_grp_t _initCmdGrpList[] = {
	...
	/* In Model User mode, we did not support ASIC driver yet. */
	{
		...
		rtl8651_tblAsicDrv_grps,		    	//group array
#else
		NULL,
		NULL,
#endif
		CMD_RTL8651_TBLASICDRV_CMD_NUM,			//exec number
		CMD_RTL8651_TBLASICDRV_GRP_NUM,		   	//group number
		0,		            					//access level
	},
#endif
#ifdef CONFIG_RTL865x_SWPUBKEY
...
/* Rtl8363_Aisc Comand */
	{
		"8363",
		"Command of RTL8363 ASIC driver",
		NULL,
		rtl8363_asic_cmds,
		NULL,
...
cle_grp_t cle_newCmdRoot[] = {
	...
	{
		"rtl867x",								//cmdStr
		"RTL867x command line interface",	//cmdDesc
		"rtl867x",								//cmdPrompt
		_initCmdList,					//List of commands in this layer	/* this line used by re_core.c for modulization */
		_initCmdGrpList,						//List of child command groups
		sizeof(_initCmdList)/sizeof(cle_exec_t),		//Number of commands in this layer /* this line used by re_core.c for modulization */
