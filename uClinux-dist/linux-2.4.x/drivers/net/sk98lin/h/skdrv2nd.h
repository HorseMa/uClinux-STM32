...
struct s_AC  {
	...
	DIM_INFO                 DynIrqModInfo; /* all data related to IM     */
	int                      PortUp;
	int                      PortDown;
...
/*******************************************************************************
 *
 * Defines and typedefs regarding power management
 *
 ******************************************************************************/


#ifdef SK_CONFIG_PM
typedef enum _SK_DEVICE_POWER_STATE
{
	SkDeviceStateUnspecified = 0,
	SkDeviceStateD0,
	SkDeviceStateD1,
	SkDeviceStateD2,
	SkDeviceStateD3,
	SkDeviceStateMaximum
} SK_DEVICE_POWER_STATE, *PSK_DEVICE_POWER_STATE;
#endif
