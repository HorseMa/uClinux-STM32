...
#define PHY_M_EC_M_DSC_MSK2	(7<<9)	/* Bit 11.. 9:	Master Downshift Counter */
									/* (88E1111 only) */
#define PHY_M_EC_DOWN_S_DIS	BIT_8S	/* Downshift Disable (88E1111 only) */
...
#define PHY_M_EC_M_DSC_2(x)		SHIFT9(x)	/* 000=1x; 001=2x; 010=3x; 011=4x */
