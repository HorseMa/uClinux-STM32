...
static unsigned short normal_addr_range[] = { I2C_CLIENT_END };
...
static int m41t11_attach(struct i2c_adapter *adap, int addr, unsigned short flags, int kind)
{
	struct i2c_client *c;
	int rc;
	int val;
...
static int m41t11_probe(struct i2c_adapter *adap)
{
...
static int m41t11_command(struct i2c_client *c, unsigned int cmd, void *arg)
{
	return 0;
}

static void m41t11_inc_use(struct i2c_client *c)
{
#ifdef MODULE
	MOD_INC_USE_COUNT;
#endif
...
static void m41t11_dec_use(struct i2c_client *c)
{
#ifdef MODULE
	MOD_DEC_USE_COUNT;
#endif
...
static struct i2c_driver m41t11_i2cdrv = {
	...
	.inc_use	= m41t11_inc_use,
	.dec_use	= m41t11_dec_use,
};
