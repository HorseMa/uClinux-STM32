 ...
 *
 *  Copyright (C) 2004,05  John Williams <jwilliams.itee.uq.edu.au>
...
int sys_ptrace(long request, long pid, long addr, long data)
{
	...
	case PTRACE_PEEKDATA:
		DBPRINTK("PEEKTEXT/PEEKDATA at %08X\n",addr); 
	...
	case PTRACE_POKEDATA:
		DBPRINTK("POKETEXT/POKEDATA to %08X\n",addr);
		rval = 0;
	...
	case PTRACE_PEEKUSR:
	case PTRACE_POKEUSR:
		DBPRINTK("PEEKUSR/POKEUSR : 0x%08x\n",addr);
		rval = 0;
	...
	case PTRACE_CONT:
		...
		DBPRINTK("calling set_single_step\n"); 
