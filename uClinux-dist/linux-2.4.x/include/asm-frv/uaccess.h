...
// For proper declarations of memory_start and memory_end
...
#define __copy_from_user(to, from, n)		__memcpy_user((to), (from), (n))
#define __copy_to_user(to, from, n)		__memcpy_user((to), (from), (n))
