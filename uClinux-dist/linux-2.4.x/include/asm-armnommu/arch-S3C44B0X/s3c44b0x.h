 ...
 * Copyright (c) 2005 Thomas Eschenbacher <thomas.eschenbacher@gmx.de>
 *
...
#define S3C44B0X_UART1_OFFSET		0x00004000
...
#define S3C44B0X_UCON_RX_MASK		0x00000003
...
/* TCON */
#define S3C44B0X_TCON_T5_MASK           0x07000000
...
#define S3C44B0X_TCON_T4_MASK           0x00F00000
...
#define S3C44B0X_TCON_T3_MASK           0x000F0000
...
#define S3C44B0X_TCON_T2_MASK           0x0000F000
...
#define S3C44B0X_BDCON0_INT          (0x00000000) /* Reserved */
#define S3C44B0X_BDCON0_QDS_EN       (0x00000000) /*Enable External/Internal DMA request*/
#define S3C44B0X_BDCON0_CMD_NO       (0x00000000) /* No Sofware commands*/
#define S3C44B0X_DST_BYTE            (0x00000000) /* Bytes are transfered*/
#define S3C44B0X_DAL_INC             (0x10000000) /* Increment */ 
#define S3C44B0X_TDM_M2IO            (0x40000000) /*from external memory to internal peripheral*/
#define S3C44B0X_DAS_INTP            (0x30000000) /*internal peripheral address*/
#define S3C44B0X_QSC_UART0           (0x80000000) /*UART0*/
#define S3C44B0X_INTS_TERM           (0x00C00000) /*Int. whenever terminated count*/
#define S3C44B0X_AR_DIS              (0x00000000) /*Auto-reload disabled*/
#define S3C44B0X_DMA_EN              (0x00100000) /*enable DMA*/
...
/* set priorities of the interrupts (master and slave) */
#define S3C44B0X_PSLV                  0x01E00010
#define S3C44B0X_PMST                  0x01E00014
