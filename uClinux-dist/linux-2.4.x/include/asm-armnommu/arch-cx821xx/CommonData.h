...
*******************************************************************************
**
**  Copyright 1997-2003 Conexant Systems, Inc.
**
*******************************************************************************
...
*******************************************************************************
** KEYWORDS:
**	$Archive:   S:/Embedded/archives/Linux/BSP_CX821xx/uClinux2.4.6/linux/include/asm-armnommu/arch-cx821xx/CommonData.h-arc  $
**	$Revision:   1.1  $
**	$Date:   Jun 30 2003 16:05:06  $
*******************************************************************************
******************************************************************************/
...
/* Define generic DSL ioctls */
#define DSL_MAGIC '%'

#define DSL_SET_PARAMS		_IOW(DSL_MAGIC, 1, struct atmif_sioc)
#define DSL_GET_PARAMS		_IOW(DSL_MAGIC, 2, struct atmif_sioc)
#define DSL_OAM_INIT		_IOW(DSL_MAGIC, 3, struct atmif_sioc)
#define DSL_OAM_RESP		_IOW(DSL_MAGIC, 4, struct atmif_sioc)
#define DSL_AAL5_VC_STATS	_IOW(DSL_MAGIC, 5, struct atmif_sioc)
#define DSL_ATM_VC_STATS	_IOW(DSL_MAGIC, 6, struct atmif_sioc)

/* TIG values are here for backwards compatibility */
#define TIGR_MAGIC 			DSL_MAGIC

#define TIG_SET_PARAMS		DSL_SET_PARAMS	
#define TIG_GET_PARAMS		DSL_GET_PARAMS	
#define TIG_OAM_INIT		DSL_OAM_INIT	
#define TIG_OAM_RESP		DSL_OAM_RESP	
#define TIG_AAL5_VC_STATS	DSL_AAL5_VC_STATS
#define TIG_ATM_VC_STATS	DSL_ATM_VC_STATS
