...
#endif
///////////////////////////////////////////////////////
// networking endian macros
///////////////////////////////////////////////////////
#define NTOHL(value) 	ntohl(value)
...
#define COMPARE_MEMORY( pDest, pSrc, size ) memcmp( pDest, pSrc, size )


#endif	//#ifdef SOFTSAR_DRIVER
