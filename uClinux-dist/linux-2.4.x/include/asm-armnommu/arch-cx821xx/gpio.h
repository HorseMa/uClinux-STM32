...
*  $Author:   belljl  $
*  $Revision:   1.4  $
*  $Modtime:   Aug 08 2003 17:58:16  $
****************************************************************************/
/******************************************************************************
****	Copyright (c) 1999, 2001, 2002, 2003 Conexant Systems, Inc.
****
*****************************************************************************
...
#undef GPOUT_EMACRESET
#define GPOUT_EMACRESET				GPIO2     /* ADM6996 Reset - Starfire Mark V Only */

#define GPOUT_GPIO5_TEST_HEADER		GPIO5     /* GPIO5 on the Test Header - Manhattan Daughtercard Only */	

#define GPOUT_GPIO8_TEST_HEADER		GPIO8     /* GPIO8 on the Test Header - Manhattan Daughtercard Only */	
#define GPOUT_GPIO9_TEST_HEADER		GPIO9     /* GPIO9 on the Test Header - Manhattan Daughtercard Only */	

#define GPIOINT_HP_INT				GPIO10    /* ZipWirePlus Device (8975) Host Port Interrupt (Active Low) */

#define GPOUT_GPIO11_TEST_HEADER	GPIO11    /* GPIO11 on the Test Header - Manhattan Daughtercard Only */	

#define GPIN_BOPT					GPIO14    /* Boot Option */

#undef GPOUT_TASKRDY_LED
#define GPOUT_TASKRDY_LED			GPIO17    /* Ready LED - Mackinac (CR4) */
#define GPOUT_SHOWTIME_LED			GPIO18    /* Showtime LED - Mackinac (CR5) */
#define GPOUT_TXD_LED				GPIO19    /* DSL TX LED - Mackinac (CR6) */
#define GPOUT_RXD_LED				GPIO20    /* DSL RX LED - Mackinac (Not connected) */

#define GPIOINT_USB_PWR				GPIO22    /* USB Power */

#if DEBUG_CONSOLE_ON_UART2
#define GPIOINT_UART1				GPIO30    /* UART2 - Mackinac (J12) */
#else
#define GPIOINT_UART1				GPIO25    /* UART1 - Mackinac (J11) */
#endif

#define GPIOINT_UART2				GPIO30    /* UART2 - Mackinac (J12) */

#define GPIOIN_FACTORY_DEFAULT		GPIO27    /* Reset to Factory Deafult */

#define GPOUT_ZIPWIRE_RESET			GPIO31    /* ZipWirePlus Device (8975) Reset */
