...
* 
*******************************************************************************
** $Archive:   S:/Embedded/archives/Linux/BSP_CX821xx/uClinux2.4.6/linux/include/asm-armnommu/arch-cx821xx/hwiodmt.h-arc  $
** $Revision:   1.2  $
** $Date:   May 14 2003 11:53:20  $
*******************************************************************************/
...
typedef enum HW_IO_ANNEX_SELECTION_
{
	ANNEX_SEL_UNDEF = 0,
	ANNEX_SEL_A,
	ANNEX_SEL_B,
...
typedef enum
{
	...
	HW_IO_EOC_CLR_TRACE			= 0x0100	// trace EOC Clear Chan		to RAM Buffer
} HW_IO_TRACE_CODES_T;
