...
#define S3C3410X_DMA_RE              (0x0001) /* DMA 0 / 1 enable */
#define S3C3410X_DMA_BS              (0x0002) /* DMA 0 / 1 busy status */
#define S3C3410X_DMA_MODE_SW         (0x0000) /* DMA source software */
#define S3C3410X_DMA_MODE_EXT        (0x0004) /* DMA source extern */
#define S3C3410X_DMA_MODE_UART       (0x0008) /* DMA source UART */
#define S3C3410X_DMA_MODE_SIO_TIMER  (0x000C) /* DMA source SIO or timer */
#define S3C3410X_DMA_DD_DEC          (0x0010) /* DMA destination address decrease */
#define S3C3410X_DMA_SD_DEC          (0x0020) /* DMA dource address decrease */
#define S3C3410X_DMA_DF              (0x0040) /* DMA destination address fix */
#define S3C3410X_DMA_SF              (0x0080) /* DMA source address fix */
#define S3C3410X_DMA_SI              (0x0100) /* DMA stop interrupt enable */
#define S3C3410X_DMA_BT              (0x0200) /* DMA 4 burst enable enable */
#define S3C3410X_DMA_SB              (0x0800) /* DMA block mode */
#define S3C3410X_DMA_TW_8            (0x0000) /* DMA transfer width byte */
#define S3C3410X_DMA_TW_16           (0x1000) /* DMA transfer width half-word */
#define S3C3410X_DMA_TW_32           (0x2000) /* DMA transfer width word */
#define S3C3410X_DMA_CM              (0x4000) /* DMA continous mode enable */
#define S3C3410X_DMA_DM              (0x8000) /* DMA demand mode */
