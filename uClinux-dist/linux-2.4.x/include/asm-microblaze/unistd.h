 ...
 * Note we don't use this any more, it's left purely for back-compatability
 * for uClibc's microblaze syscall support
 */
...
{								       	\
	...
	__asm__ __volatile__ ("addk	r5, r0, %2	\n\t"	   	\
				...
				"r" ((long)arg4),		       	\
				"r" ((long)arg5)			\
			      : "r3", "r4", "r5", "r6", "r7", "r8", "r9", "r12", "r14", "cc");\
	__syscall_return (type, __ret);				 	\
}
