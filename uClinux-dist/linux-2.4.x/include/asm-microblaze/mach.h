...
/*
 * PCI related machine dependent functions
 */
#ifdef CONFIG_PCI
/* Called in indirect_pci_config_* to avoid touching devices */
int mach_pci_exclude_device(unsigned char bus, unsigned char devfn);
#endif
