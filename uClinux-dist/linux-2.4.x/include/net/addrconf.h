/* $USAGI: addrconf.h,v 1.36 2004/01/11 08:18:16 yoshfuji Exp $ */
...
struct route_info {
	...
	__u32			lifetime;
	__u8			prefix[0];
	/* 0, 8 or 16 octet prefix follows */
};
...
extern int			ipv6_chk_acast_addr(struct net_device *dev,
						struct in6_addr *addr);
extern struct net_device *	ipv6_get_acast_dev(struct in6_addr *addr);
