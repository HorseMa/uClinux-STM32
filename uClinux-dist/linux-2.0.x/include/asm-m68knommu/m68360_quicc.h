/***********************************
 * $Id: m68360_quicc.h,v 1.2 2002-02-12 15:28:54 davidm Exp $
 ***********************************
 *
 ***************************************
...
typedef struct quicc_bd {
    ...
    /* WARNING: This is only true if char * is 32 bits */
} QUICC_BD;
...
struct dpram_mem_allocation
{
        /* BASE + 0x000: user data memory */
        QUICC_BD                smc1_tx_bd[NUMBER_TX_BUFFERS];
        QUICC_BD                smc1_rx_bd[NUMBER_RX_BUFFERS];
        QUICC_BD                smc2_tx_bd[NUMBER_TX_BUFFERS];
        QUICC_BD                smc2_rx_bd[NUMBER_RX_BUFFERS];
        QUICC_BD                scc1_tx_bd[NUMBER_TX_BUFFERS];
        QUICC_BD                scc1_rx_bd[NUMBER_RX_BUFFERS];
        QUICC_BD                scc2_tx_bd[NUMBER_TX_BUFFERS];
        QUICC_BD                scc2_rx_bd[NUMBER_RX_BUFFERS];
        QUICC_BD                scc3_tx_bd[NUMBER_TX_BUFFERS];
        QUICC_BD                scc3_rx_bd[NUMBER_RX_BUFFERS];
        QUICC_BD                scc4_tx_bd[NUMBER_TX_BUFFERS];
        QUICC_BD                scc4_rx_bd[NUMBER_RX_BUFFERS];

        QUICC_BD                enet_tx_bd[NUMBER_ENET_TX_BUFFERS];
        QUICC_BD                enet_rx_bd[NUMBER_ENET_RX_BUFFERS];
};
...
typedef struct quicc
{
        union
        {
                ...
                struct user_data		u;
                struct dpram_mem_allocation     mem_config;
        ...
        /* BRG */
        volatile unsigned long      brgc1;
        volatile unsigned long      brgc2;
        volatile unsigned long      brgc3;
        volatile unsigned long      brgc4;
        /* SCC registers */
        struct scc_regs
        {
                volatile unsigned long  gsmr_l; /* SCC general mode reg         */
                volatile unsigned long  gsmr_h; /* SCC general mode reg         */
                volatile unsigned short psmr;   /* protocol specific mode reg   */
                volatile unsigned char  RESERVED42[0x2]; /* Reserved area           */
                volatile unsigned short todr; /* SCC transmit on demand         */
                volatile unsigned short dsr;        /* SCC data sync reg        */
                volatile unsigned short scce;       /* SCC event reg            */
                volatile unsigned char  RESERVED43[0x2];/* Reserved area            */
                volatile unsigned short sccm;       /* SCC mask reg             */
                volatile unsigned char  RESERVED44[0x1];/* Reserved area            */
                volatile unsigned char  sccs;       /* SCC status reg           */
        ...
        struct smc_regs
        {
                ...
                volatile unsigned short smcmr;       /* SMC mode reg            */
                volatile unsigned char  RESERVED60[0x2]; /* Reserved area           */
                volatile unsigned char  smce;        /* SMC event reg           */
                volatile unsigned char  RESERVED47[0x3]; /* Reserved area           */
                volatile unsigned char  smcm;        /* SMC mask reg            */
        ...
        volatile unsigned char      RESERVED70[0x2];
