 ...
 *
 * $Id: intrep.c,v 1.2 2000-10-06 08:39:31 davidm Exp $
 *
 */
 ...
 *
 * On some places throughout the sources there are for instance offsets
 * that are declared as references when these really should have been
